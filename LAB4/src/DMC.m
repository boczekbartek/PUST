...
% N=112.000000; Nu=39.000000; lambda=0.010004;
% N=71.000000; Nu=71.000000; lambda=31.528399;
N=5.000000; Nu=1.000000; lambda=0.159035;
...
for i=skok+1:n
    ...
    y(i)=sym_Y2(u(i-11),u(i-12),y(i-1),y(i-2));

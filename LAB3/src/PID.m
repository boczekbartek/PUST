...
K1=1.3; Ti1=3; Td1=1; Ts=0.5; %wartooa krytyczna
r12 = K1*Td1/Ts;
r11 = K1*(Ts/(2*Ti1)-2*Td1/Ts - 1);
r10 = K1*(1+Ts/(2*Ti1) + Td1/Ts);
 
%Nastawy dla 2 regulatora
K2=1; Ti2=10; Td2=1.2; Ts=0.5; %wartooa krytyczna
r22 = K2*Td2/Ts;
...
E1=(norm(e1))^2; %WskaYnik jakooci regulacji
E2=(norm(e2))^2; %WskaYnik jakooci regulacji

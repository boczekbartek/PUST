...
\begin{figure}[ht]
	...
	\caption{Odpowiedzi skokowe procesu dla piêciu ró¿nych zmian sygna³u steruj¹cego}
...
\begin{figure}
	...
	W³aœciwoœci statyczne obiektu nie s¹ w ca³oœciowym ujêciu - wzglêdem dziedziny U - liniowe.
	Charakterystyka statyczna to z³o¿enie dwóch prostych, pierwszej szybko rosn¹cej, drugiej bardzo wolno, niemal stale, z punktem przegiêcia w okolicach $\num{-0,1}$(u)
	W³aœciwoœci dynamiczne obiektu: uk³ad jest stabilny, ma opóŸnienie w iloœci 5 chwil k, ma jedn¹ lub dwie inercje; wszystkie te cechy dynamiczne mo¿na uznaæ za w przybli¿eniu liniowe.
\end{figure}
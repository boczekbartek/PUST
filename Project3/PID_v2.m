...
E =E1+E2
nazwa = strcat('sprawozdanie/wykresy/zadanie5_PID_V2_E1.txt');
savePlot(1:1:1600,e1,nazwa);
nazwa = strcat('sprawozdanie/wykresy/zadanie5_PID_V2_E2.txt');
savePlot(1:1:1600,e2,nazwa);
nazwa = strcat('sprawozdanie/wykresy/zadanie5_PID_V2_U1.txt');
savePlot(1:1:1600,U1,nazwa);
nazwa = strcat('sprawozdanie/wykresy/zadanie5_PID_V2_Y1_zad.txt');
savePlot(1:1:1600,Y1_zad,nazwa);
nazwa = strcat('sprawozdanie/wykresy/zadanie5_PID_V2_Y1.txt');
savePlot(1:1:1600,Y1,nazwa);
nazwa = strcat('sprawozdanie/wykresy/zadanie5_PID_V2_U2.txt');
savePlot(1:1:1600,U2,nazwa);
nazwa = strcat('sprawozdanie/wykresy/zadanie5_PID_V2_Y2_zad.txt');
savePlot(1:1:1600,Y2_zad,nazwa);
nazwa = strcat('sprawozdanie/wykresy/zadanie5_PID_V2_Y2.txt');

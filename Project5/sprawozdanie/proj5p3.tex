...
Najlepszym regulatorem PID okaza³ siê ten z przypadku pierwszego, gdzie e1 na u1, e2 na u2, e3 na u3. Po przebiegach mo¿emy oceniæ, ze wahania oraz nag³e skoki sygna³u 
wyjœciowego s¹ du¿o mniejsze ni¿ w pozosta³ych PIDach, wiêc jakoœæ regulacji jest najlepsza. Potwierdza to najmniejsza wartoœæ wskaŸnika jakoœci E dla tego przypadku.\\\\
...
\begin{figure}
	Zgodnie z oczekiwaniami algorytm DMC najlepiej poradzi³ sobie z regulacj¹ tego procesu. Wartoœæ wyjœciowa jest lepiej dopasowana do watroœci zadanej ni¿ w PID, a wskaŸnik 
	jakoœci regulacji E ma mniejsz¹ wartoœæ.
\end{figure}
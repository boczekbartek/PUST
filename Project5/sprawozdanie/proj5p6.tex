...
\begin{figure}
	Mo¿emy ograniczyæ iloœæ obliczeñ poprzez zast¹pienie pe³nej macierzy K jedynie jej pierwszym elementem $\overline{K}^1$ poniewa¿ do wyznaczenia sterowania potrzebujemy jedynie u(k$\|k$) a nastêpnie mno¿ymy przez to $Y^{zad}-Y$ tak jak w poprzednim przypadku
\end{figure}
